...
import { DecryptJSON, EncryptJSON, EncryptText } from "../../Pages/components/Encrypt/CryptoEncryption";
import PaymentSuccess from "./PaymentSuccess";
...
function MockPaymentConfirmation() {
  ...
  useEffect(() => {
    ...
    const openPayment = false;

    let value;
    if (openPayment) {
      value = { orderId: "Test202208180100073", txnStatus: "TXN_SUCCESS", bankRef: "124434" };
      // setOrderValue(value)
    } else {
  ...
  return (
    <div>
      ...
      <div className="d-flex flex-column flex-column-reverse justify-content-around px-3 text-center payment_confirm" style={{ marginTop: "200px" }}>
        ...
        {status === "TXN_FAILURE" && <PaymentFailure profileData={profileData} orderId={orderId} transactionId={transactionId} orderDate={orderDate} orderValue={orderAmt} />}
...
export default MockPaymentConfirmation;
